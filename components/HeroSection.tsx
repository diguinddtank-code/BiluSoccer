...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-bisa-navy-dark pt-28 pb-16 lg:pt-32 lg:pb-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full mt-8 md:mt-0">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] xl:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-10 xl:gap-12 items-center">
          <motion.div
          ...
          >
            <motion.h1 
              ...
              className="text-4xl sm:text-6xl md:text-7xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-black text-bisa-white uppercase tracking-tighter leading-[1.05] mb-4 sm:mb-6 lg:break-words"
            >
              {t('hero.title1')} <br />
            ...
            <motion.p 
              variants={itemVariants}
              className="text-base sm:text-lg md:text-xl lg:text-lg xl:text-xl 2xl:text-2xl text-bisa-white/80 font-medium tracking-wide mb-8 sm:mb-10 max-w-xl border-l-4 border-bisa-gold pl-4"
            >
              {t('hero.subtitle')}
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
              <Link
                ...
                className="bg-bisa-gold text-bisa-navy px-6 py-3 md:px-8 md:py-4 rounded font-black text-sm md:text-base uppercase tracking-widest text-center hover:bg-white transition-colors lg:px-6 xl:px-8"
              >
                {t('hero.cta.primary')}
              </Link>
              <Link
                href="/programs"
                className="bg-transparent border-2 border-bisa-white text-bisa-white px-6 py-3 md:px-8 md:py-4 rounded font-black text-sm md:text-base uppercase tracking-widest text-center hover:bg-bisa-white hover:text-bisa-navy transition-colors lg:px-6 xl:px-8"
              >
